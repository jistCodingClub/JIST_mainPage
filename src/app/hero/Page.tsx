    ...
    return (
        ...
        <section  >
            ...
            <section
                ...
                id="heroSection"
                className="relative flex items-center justify-center overflow-hidden px-0 md:px-8 md:min-h-[calc(100vh-80px)] bg-main"
            ><LightningBackground />
                {/* Content wrapper */}
                <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-between z-10">
                    ...
                    >
                        ...
                        <div id="heroLogo" className="flex-1 flex justify-center items-center pt-8 md:pt-0 relative">
                            ...
                            {/* Logo Container */}
                            <div
                                className="relative w-80 h-80 flex items-center justify-center p-4 border-2 border-white rounded-full bg-black shadow-[0_0_20px_rgba(255,255,255,0.3)] "
                            >
                                <Image
                                    src={Logo}
